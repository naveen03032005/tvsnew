...
class long_absentees extends StatelessWidget {
  const long_absentees({Key? key}) : super(key: key);
          ...
          children: [
            ...
            // Input fields start here
             TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Admission No', // Set the label text as "Feedback"
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please provide the Admission No';
                }
                return null;
              },
            ),
            const SizedBox(height: 10),
             TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Student Name', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
            ...
            GestureDetector(
              ...
              child: AbsorbPointer(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'From Date', // Set the label text as "Date"
                    labelStyle: const TextStyle(
                      fontWeight: FontWeight.bold, // Bold label text
                      color: Colors.black87, // Set label color to black87
                      ),
             ...
             GestureDetector(
              ...
              child: AbsorbPointer(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'To Date', // Set the label text as "Date"
                    labelStyle: const TextStyle(
                      fontWeight: FontWeight.bold, // Bold label text
                      color: Colors.black87, // Set label color to black87
                      ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Reason', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
