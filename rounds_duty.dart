...
class rounds_duty extends StatelessWidget {
  const rounds_duty({Key? key}) : super(key: key);
        ...
        child: ListView(
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Area', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Observation Made', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please provide Observation made';
                }
                return null;
              },
            ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Action Taken', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please provide Action taken';
                }
                return null;
              },
            ),
