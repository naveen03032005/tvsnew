...
class curriculam_reasons extends StatelessWidget {
  const curriculam_reasons({Key? key}) : super(key: key);
        ...
        child: ListView(
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Department/Subject', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please provide Department/Subject';
                }
                return null;
              },
            ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Reason For Not Completing', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Remidial Measures', // Set the label text as "Feedback"
                labelStyle: const TextStyle(
                  fontWeight: FontWeight.bold, // Bold label text
                  color: Colors.black87, // Set label color to black87
                ),
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please provide Measures';
                }
                return null;
              },
            ),
